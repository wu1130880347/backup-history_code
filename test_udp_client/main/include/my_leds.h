...
#define LEDR_IO GPIO_4
#define LEDB_IO GPIO_2
#define LEDG_IO GPIO_16
#define LEDR_MASK (1ULL << LEDR_IO)
#define LEDG_MASK (1ULL << LEDG_IO)
#define LEDB_MASK (1ULL << LEDB_IO)

#define UART0_RX_PIN GPIO_3
#define UART0_TX_PIN GPIO_1
#define UART0_RX_PIN_MASK (1ULL << UART0_RX_PIN)
#define UART0_TX_PIN_MASK (1ULL << UART0_TX_PIN)
